    ...
    return (
        ...
        justifyContent="center" className="othermodel__content">
            <Grid item xs={4} className=""> 
                <h2><i class='bx bxs-book-add'> </i>Outros modelos</h2>
                <div className="othermodel__search"><TextField id="outlined-basic" label="Buscar modelo de contratos" variant="outlined" className="input-search"/></div>
