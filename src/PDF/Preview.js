        ...
        <View style={styles.container}>
         <View style={styles.subcontainer}>
          ...
          <View style={styles.subcontainer}>
            ...
            <Text style={styles.text}><Text style={styles.span}>NOME </Text><Text style={!dataContratado?styles.highlightedBefore:styles.highlightedAfter}>{!dataContratado?"__________":dataContratado.donome}</Text>, inscrita no CNPJ sob o nº <Text style={styles.span}>CNPJ</Text> <Text style={!dataContratado?styles.highlightedBefore:styles.highlightedAfter}>{!dataContratado?"__________":dataContratado.docpnj}</Text>, localizada na <Text style={styles.span}>ENDEREÇO</Text> <Text style={!dataContratado?styles.highlightedBefore:styles.highlightedAfter}>{!dataContratado?"__________":dataContratado.doendereco}</Text>, <Text style={styles.span}>EMAIL</Text> <Text style={!dataContratado?styles.highlightedBefore:styles.highlightedAfter}>{!dataContratado?"__________":dataContratado.doemail}</Text> e <Text style={styles.span}>TELEFONE</Text> <Text style={!dataContratado?styles.highlightedBefore:styles.highlightedAfter}>{!dataContratado?"__________":dataContratado.dotelefone}</Text>.</Text>          
          </View>
          <View style={styles.subcontainer}>
            <Text style={styles.subtitle}>CONTRATANTE: </Text> 
            <Text style={styles.text}><Text style={styles.span}>NOME</Text> <Text style={!dataContratante?styles.highlightedBefore:styles.highlightedAfter}>{!dataContratante?"__________":dataContratante.tenome}</Text>, <Text style={styles.span}>RG</Text> <Text style={!dataContratante?styles.highlightedBefore:styles.highlightedAfter}>{!dataContratante?"__________":dataContratante.terg}</Text>, <Text style={styles.span}>CPF</Text> <Text style={!dataContratante?styles.highlightedBefore:styles.highlightedAfter}>{!dataContratante?"__________":dataContratante.tecpf}</Text>, residente na <Text style={styles.span}>ENDEREÇO</Text> <Text style={!dataContratante?styles.highlightedBefore:styles.highlightedAfter}>{!dataContratante?"__________":dataContratante.teendereco}</Text>, <Text style={styles.span}>EMAIL</Text> <Text style={!dataContratante?styles.highlightedBefore:styles.highlightedAfter}>{!dataContratante?"__________":dataContratante.teemail}</Text> e <Text style={styles.span}>TELEFONE</Text> <Text style={!dataContratante?styles.highlightedBefore:styles.highlightedAfter}>{!dataContratante?"__________":dataContratante.tetelefone}</Text>. </Text> 
