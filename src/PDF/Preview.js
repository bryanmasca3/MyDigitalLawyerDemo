        ...
        <View style={styles.container}>
         <View style={styles.subcontainer}>
          ...
          <View style={styles.subcontainer}>
            ...
            <Text style={styles.text}>A <Text style={styles.span}>CONTRATANTE</Text> pagará à <Text style={styles.span}>CONTRATADA R$</Text><Text style={!dataPrecio?styles.highlightedBefore:!printh?styles.highlightedAfter:""}>{!dataPrecio?"__________":dataPrecio.preco}</Text>, equivalente ao  preço do produto.</Text>          
          </View>
          <View style={styles.subcontainer}>
            ...
            <Text style={styles.subtitle}>DADOS BANCÁRIOS</Text> 
              <View style={styles.content}>
                  <View style={styles.box}>
                    ...
                    <Text style={styles.text}><Text style={styles.span}>AGÊNCIA:</Text> <Text style={!dataDatosBanco?styles.highlightedBefore:!printh?styles.highlightedAfter:""}>{!dataDatosBanco?"__________":dataDatosBanco.agencia}</Text></Text>
                    <Text style={styles.text}><Text style={styles.span}>BENEFICIÁRIO:</Text> <Text style={!dataDatosBanco?styles.highlightedBefore:!printh?styles.highlightedAfter:""}>{!dataDatosBanco?"__________":dataDatosBanco.beneficiario}</Text></Text>
